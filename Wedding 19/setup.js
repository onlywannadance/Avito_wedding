...
const HTML_NAME = 'maket-classic.html';
const SOURCE_URL = `${BASE}/maket-classic`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-7488cdb2-9a69-483b-93da-a9d0ca510629',
  'n-95305c66-2c49-46fd-a21c-4a84b6f1d2e4',
  'n-e1d0591e-0bdc-4ed1-9c70-574f1e0a9d72',
  'n-661a8b2f-356b-49df-bb6a-368d313949b9',
];
...
console.log('Building Wedding 19 site (Classic)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Классик</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Классик</title>');
}
