...
const PAGE_ID = '118298766';
const HTML_NAME = 'maket-cream.html';
...
console.log('Building Wedding 7 site...');
...
html = html.replace('<title>Макет Крим</title>', '<title>Приглашение на свадьбу — Крим</title>');
