...
const PAGE_ID = '81901346';
const HTML_NAME = 'maket-polaroid.html';
...
console.log('Building Wedding 12 site...');
fs.mkdirSync(SITE, { recursive: true });

if (!fs.existsSync(path.join(ROOT, 'source.html'))) {
  curl('https://wedbyvaleri.ru/maket-polaroid', path.join(ROOT, 'source.html'));
}
...
html = html.replace('<title>Макет Полароид</title>', '<title>Приглашение на свадьбу — Полароид</title>');
