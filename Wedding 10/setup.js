...
const PAGE_ID = '131621746';
const HTML_NAME = 'maket-detski-new.html';
...
console.log('Building Wedding 10 site...');
...
html = html.replace('<title>Макет Детский 2</title>', '<title>Приглашение на свадьбу — Детский</title>');
