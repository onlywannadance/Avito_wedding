...
const HTML_NAME = 'maket-ether.html';
const SOURCE_URL = `${BASE}/maket-ether`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-d7d4abff-ee8d-401e-979c-c5254e244eb5',
  'n-1be14c47-e648-4664-b2d5-996b72823216',
  'n-4f6212c3-e99a-4418-9338-ff311ae12745',
  'n-5a31c676-fa80-4bfe-b52b-678d853887ed',
];
...
console.log('Building Wedding 21 site (Ether)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Эфир</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Эфир</title>');
}
