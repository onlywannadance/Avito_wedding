...
const PAGE_ID = '137201696';
const HTML_NAME = 'maket-aesthete-brown.html';
const SOURCE_URL = 'https://wedbyvaleri.ru/maket-aesthete-brown';
const TITLE_FROM = 'Макет Эстет Коричневый';
const TITLE_TO = 'Приглашение на свадьбу — Эстет Коричневый';
...
console.log('Building Wedding 16 site...');
