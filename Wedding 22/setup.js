...
const HTML_NAME = 'maket-eclipse.html';
const SOURCE_URL = `${BASE}/maket-eclipse`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-b0cc71d4-844e-4e7d-89f7-62d6e71cdcd3',
  'n-61be97aa-d573-4ade-948c-7799f7402fce',
  'n-750689d2-1830-4ea0-ac7f-c51fee8536b9',
  'n-0453c5fa-881b-4cc9-8a06-99f9b2a60c09',
];
...
function fixBackgroundVars(css) {
  return css.replace(
    ...
    'background-image:none;background-color:rgba(33,33,33,1)'
  );
}
...
console.log('Building Wedding 22 site (Eclipse)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Eclipse</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Eclipse</title>');
}
