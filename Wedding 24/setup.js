...
const HTML_NAME = 'maket-softness.html';
const SOURCE_URL = `${BASE}/maket-softness`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-f0d5c149-0467-4172-b181-4c96d0582805',
  'n-9e0a7094-c54b-452d-aec0-d3cc35a89280',
  'n-a9b989dd-8167-40f9-adfc-165223950fd9',
  'n-fd8ba221-21ed-42e4-bd85-37e59fa0da0a',
];
...
console.log('Building Wedding 24 site (Softness)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Softness</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Softness</title>');
}
