...
const HTML_NAME = 'maket-classicbej.html';
const SOURCE_URL = `${BASE}/maket-classicbej`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-89ca5ea2-ed82-455b-82a9-122c7375896b',
  'n-122e59cc-525a-4a7a-9867-27d24da6099f',
  'n-bbd6d4dd-481d-48f9-832c-59ff3c18dc61',
  'n-ac69aa95-3e55-4a3b-bb0c-a746878a352e',
];
...
console.log('Building Wedding 20 site (Classic Bej)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Классик Беж</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Классик Беж</title>');
}
