...
const HTML_NAME = 'maket-citrus.html';
const SOURCE_URL = `${BASE}/maket-citrus`;

// Desktop gate / QR overlay elements (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-7858ac53-14d2-4daa-bd29-5905eae6593b',
  'n-923c4c6e-7862-4703-a5e7-49ef76d95e1b',
  'n-284903a1-fa88-416a-b361-d9a043d80903',
  'n-ba2ad9a6-950e-412a-bdac-cbf1596cbbea',
];
...
console.log('Building Wedding 14 site...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Цитрус</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Цитрус</title>');
}
