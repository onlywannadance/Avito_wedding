...
const PAGE_ID = '86139476';
const HTML_NAME = 'maket-parallax.html';
...
console.log('Building Wedding 8 site...');
...
html = html.replace('<title>Макет Параллакс</title>', '<title>Приглашение на свадьбу — Параллакс</title>');
