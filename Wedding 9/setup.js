...
const PAGE_ID = '96463936';
const HTML_NAME = 'maket-sapphire.html';
...
console.log('Building Wedding 9 site...');
...
html = html.replace('<title>Макет Сапфир</title>', '<title>Приглашение на свадьбу — Сапфир</title>');
