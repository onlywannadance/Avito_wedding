...
const HTML_NAME = 'maket-detskii.html';
const SOURCE_URL = `${BASE}/maket-detskii`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-ba70ddc2-5a9e-4470-a2b2-132740414617',
  'n-b249ab91-2d93-4189-8852-eeed24f594ab',
  'n-5c3a73dd-e57f-4570-b503-897c64db9679',
  'n-4ead93c6-17b1-4fa0-871c-88681c1234cd',
];
...
console.log('Building Wedding 18 site (Detskii)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Детский</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Детский</title>');
}
