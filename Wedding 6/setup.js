...
const PAGE_ID = '117995746';
const HTML_NAME = 'maket-greenrose-brown.html';
...
console.log('Building Wedding 6 site...');
...
html = html.replace('<title>Макет Гринроуз КОРИЧНЕВЫЙ</title>', '<title>Приглашение на свадьбу — Гринроуз</title>');
