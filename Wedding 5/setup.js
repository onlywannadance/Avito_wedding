...
const PAGE_ID = '119935896';
const HTML_NAME = 'maket-plein.html';
...
console.log('Building Wedding 5 site...');
...
html = html.replace('<title>Макет Пленэр</title>', '<title>Приглашение на свадьбу — Пленэр</title>');
