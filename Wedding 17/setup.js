...
const HTML_NAME = 'maket-versailles.html';
const SOURCE_URL = `${BASE}/maket-versailles`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-8643d10a-10f4-45cc-b6cf-c5a78b49ad42',
  'n-b2e7eff3-a125-418d-a46e-3c0b1f1be8d2',
  'n-fa9f68b7-d378-4d4e-9a13-6d6d10405b5c',
  'n-866bbc3d-8321-4816-9cc0-67227665a051',
];
...
console.log('Building Wedding 17 site (Versailles)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Версаль</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Версаль</title>');
}
