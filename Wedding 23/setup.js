...
const HTML_NAME = 'maket-shadow.html';
const SOURCE_URL = `${BASE}/maket-shadow`;

// Desktop gate / QR overlay (hidden on mobile in original CSS)
const GATE_DESKTOP_ONLY_IDS = [
  'n-8af8386c-7d07-4d52-a211-89bcc6a8705e',
  'n-89c5c850-1c3d-48de-8e12-cc3e15296114',
  'n-7ace086f-9fbd-4576-86c9-b2696d65dbc1',
  'n-632fc2dc-531e-4c1f-8709-91427491cc02',
];
...
console.log('Building Wedding 23 site (Shadow)...');
...
if (!html.includes('<title>')) {
  html = html.replace(
    '<meta charset="utf-8"/>',
    '<meta charset="utf-8"/>\n        <title>Приглашение на свадьбу — Shadow</title>'
  );
} else {
  html = html.replace(/<title>[^<]*<\/title>/, '<title>Приглашение на свадьбу — Shadow</title>');
}
